...
def build_grammar():
    g = pearl.Grammar[
        ...
        'statements': ['expression',
                       {'ws0'}, {';'},
                       'statements']: lambda expression, rest: [(Expression(expression),) + rest],

        'statements': [{'ws0'}, {'v'}, {'a'}, {'r'},
                       'identifier',
                       {'ws0'}, {';'},
                       'statements']: lambda name, rest: [(VariableDeclaration(name),) + rest],

        'statements': ['identifier',
                       {'ws0'}, {'<'}, {'-'},
                       'expression',
                       {'ws0'}, {';'},
                       'statements']: lambda name, value, rest: [(VariableAssignment(name, value),) + rest],
        ...
        'statements': [{'ws0'}, {'i'}, {'f'},
                       ...
                       'statements',
                       {'ws0'}, {'e'}, {'n'}, {'d'},
                       'statements']: lambda condition, true_clause, false_clause, rest: [(IfThenElse(condition, true_clause, false_clause),) + rest],

        'statements': [{'ws0'}, {'w'}, {'h'}, {'i'}, {'l'}, {'e'},
                       'expression',
                       {'ws0'}, {'d'}, {'o'},
                       'statements',
                       {'ws0'}, {'e'}, {'n'}, {'d'},
                       'statements']: lambda condition, body, rest: [(WhileDo(condition, body),) + rest],
